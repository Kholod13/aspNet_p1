...
namespace UseThi.Migrations
{
    ...
    [Migration("20240422191412_AddContactLocationStatusToProductFix")]
    partial class AddContactLocationStatusToProductFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UseThi.Data.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UseThi.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("UseThi.Data.Entities.User", null)
                        .WithMany()
